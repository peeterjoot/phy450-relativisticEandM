...
Similar to light rays that move along the light cone, particles that move at speeds less than the speed of light propagate along \textunderline{worldlines} within region II (in the interior of the light cone).  At an arbitrary point in the worldline of a particle draw a 45 degree cone.  Tangent to world line should lie inside the figure lightcone of that space time point.
%
\section{Proper time.}
\index{proper time}
