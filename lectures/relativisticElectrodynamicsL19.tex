...
\end{equation}
%
Observe that \((\conj)\) is Coulomb's law measured from the instantaneous position of the charge.
...
%
\section{Extracting physics from the Lienard-Wiechert equations.}
%
