...
%\date{Mar 30, 2011}
%
\makeproblem{Wall vs. incident plane EM wave.}{pr:relativisticElectrodynamicsT9:1}{
...
The angle of incidence is measured from the normal (\citep{wiki:angleOfIncidence}.)  Let us use complex numbers to get the orientation of the electric and propagation direction fields right.  We have for the incident propagation direction
%
