...
\end{equation}
%
Here \(x,y,z\) are the free particle coordinates in an ``internal frame'', the frame where \(\ddot{\Br} = 0\) holds for a free particle (\(\ddot{\Br} = d^2 \Br/dt^2 \)) for a free particle with trajectory such as \(x = v_0 t, y = z = 0\).
%
...
The speed of the earth is approximately
\begin{equation*}
 v_{+} = 150 \times 10^6 km/ 10^7 s \approx 15 km/s.
\end{equation*}
