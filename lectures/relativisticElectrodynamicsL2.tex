...
\paragraph{A:}
%
Ah, you see, what I meant by that is the following. For a free particle \(\LL\) should depend on \(\Bx\), \(\dot{\Bx}\) and \(t\).  Homogeneity of space and time do not allow to have \(x\) and \(t\) dependence and isotropy of space only permits dependence on \(\Abs{\dot{\Bx}}\). Finally, Galilean relativity only allows \(\LL = \dot{\Bx}^2\) (times a constant). (See \citep{landau1960classical} vol 1 or \href{https://www.physics.utoronto.ca/~poppitz/epoppitz/PHY354_files/CMpp13.1-27.pdf}{my notes on PHY354 website}, p. 23-27).
