...
Would it make any difference if the surface is a perfect absorber or a reflector?  Consider a ball hitting a wall.  If it manages to embed itself in the wall, the wall will have to move a bit to conserve momentum.  However, if the ball bounces off twice the momentum has been transferred to the wall.  The numbers above would be for perfect absorption, so double them for a perfect reflector.
}
